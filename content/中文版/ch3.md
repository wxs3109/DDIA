...
<img src="../../static/fig/ddia_0301.png" alt="图 3-1. 使用关系模式表示 LinkedIn 个人资料。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0305.png" alt="图 3-5. 用于数据仓库的星型模式示例。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0308.png" alt="图 3-8. 使用不可变事件日志作为真相来源（权威数据源），并从中派生物化视图。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
