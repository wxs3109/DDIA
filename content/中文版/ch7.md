...
<img src="../../static/fig/ddia_0701.png" alt="图 7-1. 复制与分片结合使用：每个节点对某些分片充当领导者，对另一些分片充当追随者。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0703.png" alt="图 7-3. 通过对键进行哈希并取模节点数来将键分配给节点。更改节点数会导致许多键从一个节点移动到另一个节点。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
