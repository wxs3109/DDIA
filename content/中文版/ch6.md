...
<img src="../../static/fig/ddia_0601.png" alt="图 6-1. 单主复制将所有写入定向到指定的领导者，该领导者向追随者发送变更流。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0602.png" alt="图 6-2. 基于领导者的复制，带有一个同步和一个异步追随者。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0603.png" alt="图 6-3. 用户进行写入，然后从陈旧副本读取。为了防止这种异常，我们需要写后读一致性。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0604.png" alt="图 6-4. 用户首先从新鲜副本读取，然后从陈旧副本读取。时间似乎倒退了。为了防止这种异常，我们需要单调读。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0606.png" alt="图 6-6. 跨多个地区的多主复制。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0607.png" alt="图 6-7. 可以设置多主复制的三个示例拓扑。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0608.png" alt="图 6-8. 使用多主复制，写入可能以错误的顺序到达某些副本。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0609.png" alt="图 6-9. 两个领导者并发更新同一记录导致的写入冲突。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0612.png" alt="图 6-12. 节点中断后的仲裁写入、仲裁读取和读修复。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0613.png" alt="图 6-13. 如果 *w* + *r* > *n*，你读取的 *r* 个副本中至少有一个必须看到最近的成功写入。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0614.png" alt="图 6-14. Dynamo 风格数据存储中的并发写入：没有明确定义的顺序。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
