...
<img src="../../static/fig/ddia_0802.png" alt="图 8-2. 违反隔离性：一个事务读取另一个事务的未提交写入（“脏读”）。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0804.png" alt="图 8-4. 没有脏读：用户 2 只有在用户 1 的事务提交后才能看到 x 的新值。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0805.png" alt="图 8-5. 有了脏写，来自不同事务的冲突写入可能会混在一起。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0806.png" alt="图 8-6. 读取偏差：Aaliyah 观察到数据库处于不一致状态。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0807.png" alt="图 8-7. 使用多版本并发控制实现快照隔离。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0808.png" alt="图 8-8. 写偏差导致应用程序错误的示例。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0811.png" alt="图 8-11. 在可串行化快照隔离中，检测一个事务何时修改另一个事务的读取。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0813.png" alt="图 8-13. 两阶段提交（2PC）的成功执行。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<img src="../../static/fig/ddia_0814.png" alt="图 8-14. 协调器在参与者投票“是”后崩溃。数据库 1 不知道是提交还是中止。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
