# Chapter 8: CHAPTER 8: DESIGN A URL SHORTENER
...
<figure>
  <img src="images/ch08-fig01.jpeg" width="600">
</figure>

The detailed communication between clients and servers is shown in Figure 8-2.

<figure>
  <img src="images/ch08-fig02.jpeg" width="600">
</figure>
...
Let us assume the short URL looks like this: www.tinyurl.com/{hashValue}. To support the URL shortening use case, we must find a hash functionfx that maps a long URL to the hashValue, as shown in Figure 8-3.

<figure>
  <img src="images/ch08-fig03.jpeg" width="600">
</figure>
...
<figure>
  <img src="images/ch08-fig04.jpeg" width="600">
</figure>
...
<figure>
  <img src="images/ch08-fig05.jpeg" width="600">
</figure>

When $n = 7$, $62^7 \approx 3.5\text{ trillion}$, 3.5 trillion is more than enough to hold 365 billion URLs, so the length of hashValue is 7.
...
<figure>
  <img src="images/ch08-fig06.jpeg" width="600">
</figure>
...
<figure>
  <img src="images/ch08-fig07.jpeg" width="600">
</figure>
...
- $11157_{10} = 2 \times 62^2 + 55 \times 62^1 + 59 \times 62^0 = [2, 55, 59] \rightarrow \text{[2, T, X]}$ in base 62 representation. Figure 8-6 shows the conversation process.

<figure>
  <img src="images/ch08-fig08.jpeg" width="600">
</figure>
...
<figure>
  <img src="images/ch08-fig09.jpeg" width="600">
</figure>
...
<figure>
  <img src="images/ch08-fig10.jpeg" width="600">
</figure>
...
<figure>
  <img src="images/ch08-fig11.jpeg" width="600">
</figure>
...
<figure>
  <img src="images/ch08-fig12.jpeg" width="600">
</figure>
