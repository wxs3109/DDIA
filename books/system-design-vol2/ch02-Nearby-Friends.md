...
<figure>
<img src="images/ch02-fig01-facebook-s-nearby-friends.jpg" alt="A screenshot of a phone  Description automatically generated" width="600">
<figcaption><em>Figure 1 Facebook’s nearby friends</em></figcaption>
</figure>
...
| Calculate QPS |
|---|
| 100 million DAUConcurrent users: 10% x 100 million = 10 millionUsers report their locations every 30 seconds.Location update QPS = 10 million / 30 = ~334,000 |
...
<figure>
<img src="images/ch02-fig02-peer-to-peer.jpg" alt="A network of cell phones  Description automatically generated" width="600">
<figcaption><em>Figure 2 Peer-to-peer</em></figcaption>
</figure>
...
<figure>
<img src="images/ch02-fig03-shared-backend.jpg" alt="A diagram of a cloud with text  Description automatically generated" width="600">
<figcaption><em>Figure 3 Shared backend</em></figcaption>
</figure>
...
<figure>
<img src="images/ch02-fig04-high-level-design.jpg" alt="A diagram of a web socker  Description automatically generated" width="600">
...
<figure>
<img src="images/ch02-fig05-restful-api-request-flow.jpg" alt="A diagram of a computer network  Description automatically generated" width="600">
<figcaption><em>Figure 5 RESTful API request flow</em></figcaption>
</figure>
...
<figure>
<img src="images/ch02-fig06-redis-pub-sub.jpg" alt="A diagram of a network  Description automatically generated" width="600">
<figcaption><em>Figure 6 Redis Pub/Sub</em></figcaption>
</figure>
...
<figure>
<img src="images/ch02-fig07-periodic-location-update.jpg" alt="A diagram of a computer system  Description automatically generated" width="600">
<figcaption><em>Figure 7 Periodic location update</em></figcaption>
</figure>
...
<figure>
<img src="images/ch02-fig08-send-location-update-to-friends.jpg" alt="A diagram of a diagram of a connection  Description automatically generated" width="600">
<figcaption><em>Figure 8 Send location update to friends</em></figcaption>
</figure>
...
> keyvalueuser_id{latitude, longitude, timestamp}
...
> user_idlatitudelongitudetimestamp
...
1. The ability for clients (in this case, the WebSocket servers) to subscribe to any updates to the “Value” (Redis pub/sub servers).
...
<figure>
<img src="images/ch02-fig09-consistent-hashing.jpg" alt="A diagram of a network  Description automatically generated" width="600">
<figcaption><em>Figure 9 Consistent hashing</em></figcaption>
</figure>

*Figure 10 shows what happens when a WebSocket server publishes a location update to a user’s channel.*

<figure>
<img src="images/ch02-fig10-figure-out-the-correct-redis-pub-sub-server.jpg" alt="A diagram of a network connection  Description automatically generated" width="600">
<figcaption><em>Figure 10 Figure out the correct Redis pub/sub server</em></figcaption>
</figure>
...
<figure>
<img src="images/ch02-fig11-replace-pub-sub-server.jpg" alt="" width="600">
<figcaption><em>Figure 11 Replace pub/sub server</em></figcaption>
</figure>
...
The user would place a bit more load on the pub/sub server where their channel lives. Since there are many tens of pub/sub servers, these “whale” users would be spread out among the pub/sub servers and the incremental load should not overwhelm any single one.
...
One way to do this while leveraging our design is to add a pool of pub/sub channels by geohash. (See Chapter 1 Proximity Service for details on geohash). As shown in Figure 12, an area is divided into four geohash grids and a channel is created for each grid.

<figure>
<img src="images/ch02-fig12-redis-pub-sub-channels.jpg" alt="A screenshot of a map  Description automatically generated" width="600">
<figcaption><em>Figure 12 Redis pub/sub channels</em></figcaption>
</figure>

Anyone within the grid subscribes to the same channel. Let’s take grid 9q8znd for example as shown in Figure 13.

<figure>
<img src="images/ch02-fig13-publish-location-update-to-random-nearby-person.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 13 Publish location update to random nearby person</em></figcaption>
</figure>
...
<figure>
<img src="images/ch02-fig14-nine-geohash-grids.jpg" alt="A map with green dots and black lines  Description automatically generated" width="600">
<figcaption><em>Figure 14 Nine geohash grids</em></figcaption>
</figure>
