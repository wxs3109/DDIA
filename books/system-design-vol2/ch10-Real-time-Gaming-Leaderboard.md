...
<figure>
<img src="images/ch10-fig01-leaderboard-for-marvel-contest-of-champions.jpg" alt="A screenshot of a video game  Description automatically generated" width="600">
<figcaption><em>Figure 1 Leaderboard for Marvel Contest of Champions</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig02-high-level-design.jpg" alt="A diagram of a leaderboard service  Description automatically generated" width="600">
...
2. the rank of the player on the leaderboard.
...
<figure>
<img src="images/ch10-fig03-who-sets-the-leaderboard-score.jpg" alt="A diagram of a process  Description automatically generated" width="600">
<figcaption><em>Figure 3 Who sets the leaderboard score</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig04-game-scores-are-used-by-multiple-services.jpg" alt="A diagram of a cylinder with a light and words  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 4 Game scores are used by multiple services</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig05-leaderboard-table.jpg" alt="A white rectangular box with black text  Description automatically generated" width="600">
<figcaption><em>Figure 5 Leaderboard table</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig06-a-user-wins-a-point.jpg" alt="A black text on a white background  Description automatically generated" width="600">
<figcaption><em>Figure 6 A user wins a point</em></figcaption>
</figure>
...
```
INSERTINTO leaderboard (user_id, score) VALUES ('mary1934', 1);
```
...
<figure>
<img src="images/ch10-fig07-find-a-user-s-leaderboard-position.jpg" alt="A black text on a white background  Description automatically generated" width="600">
<figcaption><em>Figure 7 Find a user’s leaderboard position</em></figcaption>
</figure>

To fetch the user rank, you would sort the leaderboard table and rank by the score:

```
SELECT (@rownum := @rownum + 1) ASrank, user_id, scoreFROMleaderboardORDERBYscoreDESC;
```
...
```
SELECT (@rownum := @rownum + 1) ASrank, user_id, scoreFROMleaderboardORDERBYscoreDESCLIMIT10
```
...
<figure>
<img src="images/ch10-fig08-february-leaderboard-is-represented-by-the-sorted.jpg" alt="A screenshot of a graph  Description automatically generated" width="600">
<figcaption><em>Figure 8 February leaderboard is represented by the sorted set</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig09-skip-list.jpg" alt="A diagram of a work flow  Description automatically generated" width="600">
<figcaption><em>Figure 9 Skip list</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig10-skip-list-with-5-levels-of-indexes.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 10 Skip list with 5 levels of indexes</em></figcaption>
</figure>
...
```
SELECT *,(SELECTCOUNT(*) FROM leaderboard lb2 
WHERE lb2.score >= lb1.score) RANKFROM leaderboard lb1 
...
<figure>
<img src="images/ch10-fig11-a-user-scores-a-point.jpg" alt="A black text with black text  Description automatically generated" width="600">
<figcaption><em>Figure 11 A user scores a point</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig12-fetch-top-10-global-leaderboard.jpg" alt="A black text on a white background  Description automatically generated" width="600">
<figcaption><em>Figure 12 Fetch top 10 global leaderboard</em></figcaption>
</figure>
...
```
ZREVRANGE leaderboard_feb_2021 09 WITHSCORES
```
...
<figure>
<img src="images/ch10-fig13-fetch-a-user-s-leaderboard-position.jpg" alt="A black text with a black line  Description automatically generated" width="600">
<figcaption><em>Figure 13 Fetch a user’s leaderboard position</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig14-fetch-4-players-above-and-below-the-desired-player.jpg" alt="A screenshot of a video game  Description automatically generated" width="600">
<figcaption><em>Figure 14 Fetch 4 players above and below the desired player</em></figcaption>
</figure>
...
```
ZREVRANGE leaderboard_feb_2021 357365
```
...
- Whether or not to use a cloud provider Manage our own servicesLeverage cloud service providers like Amazon Web Services (AWS)
- Scaling Redis
...
<figure>
<img src="images/ch10-fig15-manage-our-own-services.jpg" alt="A diagram of a web server  Description automatically generated" width="600">
<figcaption><em>Figure 15 Manage our own services</em></figcaption>
</figure>
...
> APIsLambda functionGET /v1/scores/{:user_id}LeaderboardFetchTop10GET /v1/scoresLeaderboardFetchPlayerRankPOST /v1/scoresLeaderboardUpdateScore
...
<figure>
<img src="images/ch10-fig16-score-a-point.jpg" alt="A diagram of a software company  Description automatically generated" width="600">
<figcaption><em>Figure 16 Score a point</em></figcaption>
</figure>

Use Case 2: retrieving leaderboard

<figure>
<img src="images/ch10-fig17-retrieve-leaderboard.jpg" alt="A diagram of a network  Description automatically generated" width="600">
<figcaption><em>Figure 17 Retrieve leaderboard</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig18-fixed-partition.jpg" alt="" width="600">
<figcaption><em>Figure 18 Fixed partition</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig19-hash-partition.jpg" alt="A diagram of a server  Description automatically generated" width="600">
<figcaption><em>Figure 19 Hash partition</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig20-scatter-gather.jpg" alt="A diagram of a computer program  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 20 Scatter-gather</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig21-dynamodb-solution.jpg" alt="A logo with text and a cross  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 21 DynamoDB solution</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig22-denormalized-view-of-the-leaderboard-and-user-tabl.jpg" alt="A close-up of a list  Description automatically generated" width="600">
<figcaption><em>Figure 22 Denormalized view of the leaderboard and user tables</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig23-partition-key-and-sort-key.jpg" alt="A close-up of a list  Description automatically generated" width="600">
<figcaption><em>Figure 23 Partition key and sort key</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig24-updated-partition-key.jpg" alt="A close-up of a list  Description automatically generated" width="600">
<figcaption><em>Figure 24 Updated partition key</em></figcaption>
</figure>
...
<figure>
<img src="images/ch10-fig25-scatter-gather.jpg" alt="A diagram of a group of data  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 25 Scatter-gather</em></figcaption>
</figure>
