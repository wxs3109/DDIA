...
<figure>
<img src="images/ch04-fig01-popular-distributed-message-queues.jpg" alt="A close-up of a logo  Description automatically generated" width="600">
<figcaption><em>Figure 1 Popular distributed message queues</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig02-key-components-in-a-message-queue.jpg" alt="" width="600">
<figcaption><em>Figure 2 Key components in a message queue</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig03-point-to-point-model.jpg" alt="A diagram of a message  Description automatically generated" width="600">
<figcaption><em>Figure 3 Point-to-point model</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig04-publish-subscribe-model.jpg" alt="A diagram of a message  Description automatically generated" width="600">
<figcaption><em>Figure 4 Publish-subscribe model</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig05-partitions.jpg" alt="A black and white image of a arrow  Description automatically generated" width="600">
<figcaption><em>Figure 5 Partitions</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig06-message-queue-cluster.jpg" alt="A white square with black text  Description automatically generated" width="600">
<figcaption><em>Figure 6 Message queue cluster</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig07-consumer-groups.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 7 Consumer groups</em></figcaption>
</figure>
...
To support the point-to-point model, we can allocate way more partitions in advance to avoid the need to change the partition number. In practice, there will be way more partitions than consumers. To scale, we just need to add more consumers.
...
<figure>
<img src="images/ch04-fig08-high-level-design.jpg" alt="A diagram of a data storage system  Description automatically generated" width="600">
<figcaption><em>Figure 8 High-level design</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig09-append-new-messages.jpg" alt="A white rectangular object with black numbers  Description automatically generated" width="600">
<figcaption><em>Figure 9 Append new messages</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig10-data-segment-file-distribution-in-topic-partitions.jpg" alt="A screenshot of a computer screen  Description automatically generated" width="600">
<figcaption><em>Figure 10 Data segment file distribution in topic partitions</em></figcaption>
</figure>
...
> ReminderThe key and value of a message are different from the key-value pair in a key-value (KV) store. In the KV store, keys are unique, and we can find the value by key. In a message, keys do not need to be unique. Sometimes they are not even mandatory, and we don’t need to find a value by key.
...
<figure>
<img src="images/ch04-fig11-routing-layer.jpg" alt="A diagram of a production process  Description automatically generated" width="600">
<figcaption><em>Figure 11 Routing layer</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig12-producer-with-buffer-and-routing.jpg" alt="A diagram of a production process  Description automatically generated" width="600">
<figcaption><em>Figure 12 Producer with buffer and routing</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig13-the-choice-of-the-batch-size.jpg" alt="A line graph with a point  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 13 The choice of the batch size</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig14-consumer-flow.jpg" alt="A diagram of a number  Description automatically generated" width="600">
<figcaption><em>Figure 14 Consumer flow</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig15-pull-model.jpg" alt="A diagram of a consumer  Description automatically generated" width="600">
<figcaption><em>Figure 15 Pull model</em></figcaption>
</figure>

1. A new consumer wants to join group 1 and subscribes to topic A. It finds the corresponding broker node by hashing the group name. By doing so, all the consumers in the same group connect to the same broker, which is also called the coordinator of this consumer group. Despite the naming similarity, the consumer group coordinator is different from the coordination service mentioned in Figure 8. The former coordinates the consumer group, while the latter coordinates the broker cluster.
...
<figure>
<img src="images/ch04-fig16-coordinator-of-consumer-groups.jpg" alt="A diagram of a group  Description automatically generated" width="600">
<figcaption><em>Figure 16 Coordinator of consumer groups</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig17-consumer-rebalance.jpg" alt="A group of people with numbers and arrows  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 17 Consumer rebalance</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig18-new-consumer-joins.jpg" alt="A screenshot of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 18 New consumer joins</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig19-existing-consumer-leaves.jpg" alt="A screenshot of a computer  Description automatically generated" width="600">
<figcaption><em>Figure 19 Existing consumer leaves</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig20-existing-consumer-crashes.jpg" alt="A screenshot of a computer  Description automatically generated" width="600">
<figcaption><em>Figure 20 Existing consumer crashes</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig21-last-consumed-offset-of-consumer-groups.jpg" alt="A diagram of a number of people  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 21 Last consumed offset of consumer groups</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig22-zookeeper.jpg" alt="A diagram of a computer server  Description automatically generated" width="600">
<figcaption><em>Figure 22 Zookeeper</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig23-replication.jpg" alt="A diagram of a diagram  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 23 Replication</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig24-how-isr-works.jpg" alt="A diagram of a number  Description automatically generated" width="600">
<figcaption><em>Figure 24 How ISR works</em></figcaption>
</figure>
...
*Figure 25 illustrates the case with ACK=all. With ACK=all, the producer gets an ACK when all ISRs have received the message. This means it takes a longer time to send a message because we need to wait for the slowest ISR, but it gives the strongest message durability. Please note, ACK=all is only effective if the number of ISRs is not below the configured minimum ISR amount (min.insync.replicas configuration in Kafka). In Figure 25, min.insync.replicas is set to 2.*

<figure>
<img src="images/ch04-fig25-ack-all.jpg" alt="A diagram of a production process  Description automatically generated" width="600">
<figcaption><em>Figure 25 ACK=all</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig26-ack-1.jpg" alt="A diagram of a production process  Description automatically generated" width="600">
<figcaption><em>Figure 26 ACK=1</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig27-ack-0.jpg" alt="A diagram of a production process  Description automatically generated" width="600">
<figcaption><em>Figure 27 ACK=0</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig28-broker-node-crashes.jpg" alt="A diagram of a diagram  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 28 Broker node crashes</em></figcaption>
</figure>
...
1. Broker 3 crashes, which means all the partitions on the node are lost. The partition distribution plan is changed to:
2. The broker controller detects broker 3 is down and generates a new partition distribution plan for the remaining broker nodes:
3. The new replicas work as followers and catch up with the leader.
...
<figure>
<img src="images/ch04-fig29-add-new-broker-node.jpg" alt="A diagram of a diagram  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 29 Add new broker node</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig30-partition-increase.jpg" alt="A screenshot of a computer screen  Description automatically generated" width="600">
<figcaption><em>Figure 30 Partition increase</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig31-partition-decrease.jpg" alt="A screenshot of a computer screen  Description automatically generated" width="600">
<figcaption><em>Figure 31 Partition decrease</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig32-at-most-once.jpg" alt="" width="600">
<figcaption><em>Figure 32 At-most once</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig33-at-least-once.jpg" alt="" width="600">
<figcaption><em>Figure 33 At-least once</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig34-exactly-once.jpg" alt="" width="600">
<figcaption><em>Figure 34 Exactly once</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig35-message-filtering-by-tags.jpg" alt="A diagram of a bag and fetcher  Description automatically generated" width="600">
<figcaption><em>Figure 35 Message filtering by tags</em></figcaption>
</figure>
...
<figure>
<img src="images/ch04-fig36-delayed-messages.jpg" alt="A diagram of a few messages  Description automatically generated" width="600">
<figcaption><em>Figure 36 Delayed messages</em></figcaption>
</figure>
