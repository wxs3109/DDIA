...
<figure>
<img src="images/ch06-fig01-rtb-process.jpg" alt="" width="600">
<figcaption><em>Figure 1 RTB process</em></figcaption>
</figure>
...
API 1: Aggregate the number of clicks of ad_idin the last M minutes.
...
> FieldDescriptionTypefromStart minute (default is to move 1 minute backwardlongtoEnd minute (default is now)longfilterAn identifier for different filtering strategies. For example, filter = 001 filters out non-US clickslong

*Table 2 Request parameters for /v1/ads/{:ad_id}/aggregated_count*

Response:
> FieldDescriptionTypead_idThe identifier of the adstringcountThe aggregated count between the start and end minuteslong

*Table 3 Response for /v1/ads/{:ad_id}/aggregated_count*

API 2: Return top N most clicked ad_idsin the last \(M\) minutes
> APIDetailGET /ads/popular_adsReturn top N most clicked ads in the last M minutes

*Table 4 API for /v1/ads/popular_ads*

Request parameters are:
> FieldDescriptionTypecountTop N most clicked adsintegerwindowThe aggregation window size (M) in minutesintegerfilterAn identifier for different filtering strategieslong

*Table 5 Request parameters for /v1/ads/popular_ads*

Response:
> FieldDescriptionTypead_idsA list of the most clicked adsarray
...
> ad_idclick_timestampuser_idipcountryad0012021-01-01 00:00:01user1207.148.22.22USAad0012021-01-01 00:00:02user1207.148.22.22USAad0022021-01-01 00:00:02user2209.153.56.11USA
...
| update_time_minute | timestamp | Last updated timestamp (granularity is minute) |
...
<figure>
<img src="images/ch06-fig04-end-to-end-exactly-once.jpg" alt="A diagram of a data flow  Description automatically generated" width="600">
<figcaption><em>Figure 4: End-to-end exactly once</em></figcaption>
</figure>
...
The MapReduce framework is a good option to aggregate ad click events. The directed acyclic graph (DAG) is a good model for it [10]. The key to the DAG model is to break down the system into small computing units, like the Map/Aggregate/Reduce nodes, as shown in Figure 5.

<figure>
<img src="images/ch06-fig05-aggregation-service.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 5 Aggregation service</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig06-map-operation.jpg" alt="A diagram of a map  Description automatically generated" width="600">
<figcaption><em>Figure 6 Map operation</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig07-reduce-node.jpg" alt="A diagram of a graph  Description automatically generated" width="600">
<figcaption><em>Figure 7 Reduce node</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig08-aggregate-the-number-of-clicks.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 8 Aggregate the number of clicks</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig09-return-top-n-most-clicked-ads.jpg" alt="A diagram of a function  Description automatically generated" width="600">
<figcaption><em>Figure 9 Return top N most clicked ads</em></figcaption>
</figure>
...
> Services (Online system)Batch system (offline system)Streaming system (near real-time system)ResponsivenessRespond to the client quicklyNo response to the client neededNo response to the client neededInputUser requestsBounded input with finite size. A large amount of dataInput has no boundary (infinite streams)OutputResponses to clientsMaterialized views, aggregated metrics, etc.Materialized views, aggregated metrics, etc.Performance measurementAvailability,latencyThroughputThroughput, latencyExampleOnline shoppingMapReduceFlink [13]
...
<figure>
<img src="images/ch06-fig10-lambda-and-kappa-architectures.jpg" alt="A diagram of a layer structure  Description automatically generated" width="600">
<figcaption><em>Figure 10 Lambda and Kappa architectures</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig11-recalculation-service.jpg" alt="A diagram of a data flow  Description automatically generated" width="600">
<figcaption><em>Figure 11 Recalculation service</em></figcaption>
</figure>
...
- Processing time: refers to the system time of the aggregation machine that processes the click event.
...
<figure>
<img src="images/ch06-fig12-late-events.jpg" alt="A diagram of numbers and points  Description automatically generated" width="600">
<figcaption><em>Figure 12 Late events</em></figcaption>
</figure>
...
> ProsConsEvent timeAggregation results are more accurate because the client knows exactly when an ad is clickedIt depends on the timestamp generated on the client-side. Clients might have the wrong time, or the timestamp might be generated by malicious usersProcessing timeServer timestamp is more reliableThe timestamp is not accurate if an event reaches the system at a much later time
...
<figure>
<img src="images/ch06-fig13-miss-events-in-an-aggregation-window.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 13 Miss events in an aggregation window</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig14-watermark.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 14 Watermark</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig15-tumbling-window.jpg" alt="A close-up of a graph  Description automatically generated" width="600">
<figcaption><em>Figure 15 Tumbling window</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig16-sliding-window.jpg" alt="A black and white text  Description automatically generated with medium confidence" width="600">
<figcaption><em>Figure 16 Sliding window</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig17-duplicate-data.jpg" alt="A black background with white text  Description automatically generated" width="600">
<figcaption><em>Figure 17 Duplicate data</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig18-record-the-offset.jpg" alt="A screenshot of a computer  Description automatically generated" width="600">
<figcaption><em>Figure 18 Record the offset</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig19-save-offset-after-receiving-ack.jpg" alt="A screenshot of a computer  Description automatically generated" width="600">
<figcaption><em>Figure 19 Save offset after receiving ack</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig20-distributed-transaction.jpg" alt="A screenshot of a computer  Description automatically generated" width="600">
<figcaption><em>Figure 20 Distributed transaction</em></figcaption>
</figure>
...
From the back-of-the-envelope estimation, we know the business grows 30% per year, which leads to a doubling of capacity every 3 years. How do we handle this growth? Let’s take a look.
...
<figure>
<img src="images/ch06-fig21-add-consumers.jpg" alt="A screenshot of a computer screen  Description automatically generated" width="600">
<figcaption><em>Figure 21 Add consumers</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig22-aggregation-service.jpg" alt="A diagram of a map process  Description automatically generated" width="600">
<figcaption><em>Figure 22 Aggregation service</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig23-multi-threading.jpg" alt="A diagram of a service node  Description automatically generated" width="600">
<figcaption><em>Figure 23 Multi-threading</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig24-virtual-nodes-21.jpg" alt="A screenshot of a computer keyboard  Description automatically generated" width="600">
<figcaption><em>Figure 24 Virtual nodes [21]</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig25-allocate-more-aggregation-nodes.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 25 Allocate more aggregation nodes</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig26-data-in-a-snapshot.jpg" alt="A diagram of a computer program  Description automatically generated" width="600">
<figcaption><em>Figure 26 Data in a snapshot</em></figcaption>
</figure>
...
<figure>
<img src="images/ch06-fig27-aggregation-node-failover.jpg" alt="A diagram of a diagram  Description automatically generated" width="600">
<figcaption><em>Figure 27 Aggregation node failover</em></figcaption>
</figure>
