...
<img src="../../static/map/ch10.png" alt="章节导图" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<a id="fig_batch_mapreduce"></a>

图 11-1. 一个包含三个 mapper 和三个 reducer 的 MapReduce 作业。

<img src="../../static/fig/ddia_1101.png" alt="图 11-1. 一个包含三个 mapper 和三个 reducer 的 MapReduce 作业。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<a id="fig_batch_join_example"></a>

图 11-2. 用户活动日志与用户画像数据库的连接。

<img src="../../static/fig/ddia_1102.png" alt="图 11-2. 用户活动日志与用户画像数据库的连接。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
...
<a id="fig_batch_join_reduce"></a>

图 11-3. 基于用户 ID 的排序合并连接。若输入数据集由多个文件分片组成，可并行启动多个 mapper 处理。

<img src="../../static/fig/ddia_1103.png" alt="图 11-3. 基于用户 ID 的排序合并连接。若输入数据集由多个文件分片组成，可并行启动多个 mapper 处理。" style="display: block; margin: 1rem auto; width: 100%; max-width: 720px;" />
